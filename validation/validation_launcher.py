...
from validation.ValidationLib import HDF5Loader, ValidationTextTo3DModel as validation
...
if __name__ == '__main__':
    ...
    data_dict = loader.load_point_cloud_from_h5("frog", "/home/tesha/Documents/Python/404_dream_gaussian/mining/logs/output7")
    pcl_buffer = loader.pack_point_cloud_to_io_buffer(data_dict['points'], data_dict['normals'], data_dict['features_dc'], data_dict['features_rest'],
                                                      data_dict['opacities'], data_dict['scale'], data_dict['rotation'], data_dict['sh_degree'])
