...
from imagedream.ldm.modules.diffusionmodules.adaptors import Resampler, ImageProjModel
    ...
    def __init__(
        ...
        if self.with_ip and (context_dim is not None) and ip_dim > 0:
            if self.ip_mode == "local_resample":
                ...
                self.image_embed = ImageProjModel(cross_attention_dim=context_dim, clip_extra_context_tokens=ip_dim)
            else:
